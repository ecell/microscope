...
def test_epifm() :
	...
	epifm.set_BeamExpander(expander_type='Keplerian', focal_length1=100e-3, focal_length2=20e-3, pinhole_radius=23e-6)
	...
	epifm.set_TubeLens(focal_length=160e-3)
	...
	#create.get_plots(plot_filename='./plots/epifm_plots.pdf', wave_length=610)
