...
def test_confm(t0, t1) :
	...
	confm.set_Detector(detector='PMT', zoom=1, emgain=1e+6, focal_point=(0.9,0.5,0.5), \
			exposure_time=0.50, bandwidth=50e+3, mode='Pulse')
	confm.set_ADConverter(bit=16, offset=2000, fullwell=60000)
	confm.set_OutputData(image_file_dir='./images_dicty_00_point')
	confm.set_InputData('/home/masaki/ecell3/latest/data/csv/simple_dicty_00', start=t0, end=t1)
