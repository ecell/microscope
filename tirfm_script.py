...
def test_tirfm(t0, t1) :
	...
	tirfm.set_Detector(detector='EMCCD', zoom=1, emgain=300, focal_point=(0.0,0.5,0.5), \
			fpn_type=None, fpn_noise=20, \
			start_time=t0, end_time=t1, fps=1.0/3.0e-3, exposure_time=30e-3)
	tirfm.set_Movie(image_file_dir='./images_HRG', movie_filename='./movies/tirfm_movie.mp4')
	#tirfm.set_DataFile(['./data/lattice/test_model_07.h5'])
	tirfm.set_DataFile(['/home/kiwamoto/share/HRG_membrane/vlog_HRG_ErbB1000.h5'], observable='R')
