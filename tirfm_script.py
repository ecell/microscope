...
def test_image() :
    ...
    tirfm.set_Fluorophore(fluorophore_type='Gaussian', wave_length=550, param=(70.0, 70.0))
    #tirfm.set_Fluorophore(fluorophore_type='Point-like')
    ...
    tirfm.set_Camera(camera='EMCCD', zoom=0.8, focal_point=(0.0,0.5,0.5), \
