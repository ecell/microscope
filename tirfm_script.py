...
def test_tirfm() :
	...
	# Spectral Arrangement
        tirfm.set_LightSource(source_type='LASER', wave_mode='TEM00', M2_factor=1.4, wave_length=473, power=10e-3, radius=0.32e-3)
        tirfm.set_BeamExpander(expander_type='Keplerian', focal_length1=30e-3, focal_length2=40e-3, pinhole_radius=23e-6)
